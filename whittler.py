...
def party_usage(user_data, message):
    return "To submit a game for me to suffer through use !add <game_title>. The entire list can be found with !queue. Use !ditch to take your games out of the queue. Unavailable games: https://sd2snes.de/blog/compatibility"
